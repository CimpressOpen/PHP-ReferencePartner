			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" href="#collapse1">Get Order Information</a>
							</h4>
						</div>
						<div id="collapse1" class="panel-collapse collapse">
							<div class="panel-body">
								<form method="POST" action="">
									...
									<p>
										<button type="submit" class="btn btn-sm btn-info dropdown" name="GetOrder">GO!</button>
									</p>
								</form>
							</div>
						</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" href="#collapse2">Create Order</a>
							</h4>
						</div>
								...
								<form method="POST" action="">
									...
									<div class="well">
										...
										<div class="form-group">
											...
											<input type="num" min="0" class="form-control" id="DeliveryOptionId" name="DeliveryOptionId">
									...
									<div class="well">
										...
										<div class="form-group">
											...
											<input type="num" min="0" class="form-control" id="DocumentInstructionVersion" name="DocumentInstructionVersion">
											<span id="helpBlock" class="help-block">Should be '2'</span>
										</div>
									</div>
									<p>
										<button type="submit" class="btn btn-sm btn-info dropdown" name="CreateOrder">GO!</button>
									</p>
								</form>
							</div>
						</div>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<?php 
						...
						{ 
						echo'<pre>';
						show_source ("../exampleSnippets/getOrder.php");
						echo'</pre>';	
						}
						if (isset($_POST['CreateOrder'])) 
						{ 
						echo'<pre>';
						show_source ("../exampleSnippets/createOrder.php");
						echo'</pre>';	
						}
						?> 
				</div>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<?php 
						...
						$Response = $CimpressOpen->GetOrder($OrderId);
						echo"<pre>";
						...
						$Response = $CimpressOpen->PlaceOrder($SKU, $Quantity,
